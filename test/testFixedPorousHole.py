...
def test_fixed_porous_hole():
    ...
    chombo_compare_analyse ='python %s -f %s -a -v \'xDarcy velocity\' -e L2 -r True -n 5 \n \n' % (python_compare_file, data_folder)
    ...
    # Run
    extra_params = {}
    runTest(data_folder, physical_problem, amr_setup, num_procs, analysis_command, extra_params)
