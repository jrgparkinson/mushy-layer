...
params = readInputs(mushyLayerBaseDir + '/params/convergenceTest/mushyLayerDarcyConvTest.parameters')
...
grid_res_arr = [32, 64, 128, 256]
prevFinalChkFile = ''
stepInterval = 10000
maxStep = stepInterval
