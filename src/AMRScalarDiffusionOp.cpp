...
void AMRScalarDiffusionOpFactory::define(const ProblemDomain&                           a_coarseDomain,
...
//    VCAMRPoissonOp2Factory* vcop = <VCAMRPoissonOp2Factory*>(this);
  VCAMRPoissonOp2Factory::define(a_coarseDomain, a_grids, a_refRatios, a_coarsedx, a_bc, a_alpha, a_aCoef, a_beta, a_bCoef);
