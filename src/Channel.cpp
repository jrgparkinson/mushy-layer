...
Channel::Channel() { m_finished = false; }
...
bool Channel::isFinished() { return m_finished; }

void Channel::setFinished() { m_finished = true; }

// void channelSpacing(Vector<Real>& a_spacing, Vector<Channel*>& a_channels,
// Real a_dx)
