 ...
 * \f$ D \nabla \cdot \chi \nabla (\xi/\chi) \f$
 *
 * where \f$D\f$ is the diffusion coefficient, \f$ \xi\f$ is the bulk
 * concentration of whatever we're diffusing, and \f$ \chi\f$ is the porosity.
 *
 * This class is unfinished. Just using VCAMRPOissonOp2. Writing this class
...
public:
  ...
  //  {
  //
  //    define(a_coarseDomain, a_grids, a_refRatios, a_coarsedx, a_bc, a_alpha,
  //    a_aCoef, a_beta, a_bCoef); m_porosity = a_porosity;
  //  }
