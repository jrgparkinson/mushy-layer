...
% Specify location of plot files.
% Loads the file at
%     {output_dir}{actual_plot_prefix}{thisFrame}.2d.hdf5 
% where {thisFrame} is padded with 0's as needed
% so in this case, 
% /home/parkinsonjl/mushy-layer/execSubcycle/enceladus/plt000500.2d.hdf5
output_dir = '/home/parkinsonjl/mushy-layer/execSubcycle/enceladus/';
...
options.topFraction = 0.99;
options.fluidVelScale = 200;
options.pcolorField = 'porosity'; %porosity, Sl
options.timeTitle = false;
options.numFrames = 1;
options.axPos =[0.1 0.1 0.6 0.75];
options.maxSearchFrame = 100000;
options.subPlotLabel = '';
